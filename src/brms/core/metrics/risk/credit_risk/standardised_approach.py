...
class ExposureChecker:
    ...
    @staticmethod
    def is_real_estate_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
        """Check if the instrument is a real estate exposure."""
        return RealEstateInstrumentRegistry.has_instrument(instrument)

    @staticmethod
    def is_retail_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
    ...
    @staticmethod
    def is_PSE_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
    ...
    @staticmethod
    def is_corporate_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
    ...
    @staticmethod
    def is_bank_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
    ...
    @staticmethod
    def is_short_term_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
    ...
    @staticmethod
    def is_securities_firm_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
        """Check if the instrument qualifies securities firm exposure."""
        return instrument.issuer.is_securities_firm()

    @staticmethod
    def is_credit_derivative_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
        """Check if the instrument qualifies credit derivative exposure."""
        return False

    @staticmethod
    def is_defaulted_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
        """Check if the instrument qualifies defaulted exposure."""
        return False

    @staticmethod
    def is_cash_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
        """Check if the instrument is cash."""
        return isinstance(instrument, Cash)

    @staticmethod
    def is_other_exposure(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
...
class StandardisedApproach(RWAApproach):
    ...
    def compute_rwa(
        self, bank: Any, date: datetime.date, scenario_manager: Any, verbose: bool = False,  # noqa: ANN401
    ) -> float:
        """Compute the Risk-Weighted Assets (RWA) for a given bank and scenario."""
        rwa = 0.0
        exposures: list[tuple[str, Callable[[Any, Any], float]]] = [
    ...
    def _compute_sovereign_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
    ...
    def _compute_PSE_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
    ...
    def _compute_MDB_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
    ...
    def _compute_bank_exposures(
        ...
        scenario_manager: Any,  # noqa: ANN401
    ...
    def _compute_covered_bonds_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
    ...
    def _compute_securities_firms_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
    ...
    def _compute_corporate_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
    ...
    def _compute_subordinated_debt_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
        """Compute the RWA for subordinated debt, equity and other capital instruments exposures."""
        raise NotImplementedError

    def _compute_retail_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
        ...
        def is_regulatory_retail(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
            """TODO: Check if the exposure qualifies regulatory retail."""
            return False

        def is_transactor(instrument: Instrument, bank: Any) -> bool:  # noqa: ANN401
    ...
    def _compute_real_estate_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
    ...
    def _compute_currency_mismatch_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
        """Compute the RWA for risk weight multiplier to certain exposures with currency mismatch."""
        raise NotImplementedError

    def _compute_off_balance_sheet_items(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
        """Compute the RWA for off-balance sheet items."""
        raise NotImplementedError

    def _compute_counterparty_credit_risk_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
    ...
    def _compute_credit_derivatives_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
        """Compute the RWA for credit derivatives."""
        raise NotImplementedError

    def _compute_defaulted_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
        """Compute the RWA for defaulted exposures."""
        raise NotImplementedError

    def _compute_other_assets_exposures(self, bank: Any, scenario_manager: Any) -> float:  # noqa: ANN401
