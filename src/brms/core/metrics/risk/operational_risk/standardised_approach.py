...
class StandardisedApproach(RWAApproach):
    ...
    def _compute_business_indicator(self, bank: Any, date: datetime.date, scenario_manager: Any) -> float:  # noqa: ANN401
...
class ILDCCalculator:
    ...
    @staticmethod
    def compute(bank: Any, date: datetime.date, scenario_manager: Any) -> float:  # noqa: ANN401
