"""T-account types, chart of accounts, and account classifications.

Migrated from brms.accounting.account with Observable/Observer pattern removed.
The EventBus replaces observer notifications at the service layer.
"""
