...
from brms.views.base import BaseCalculatorWidget, CustomDoubleSpinBox
...
class BondCalculatorWidget(BaseCalculatorWidget):
    def __init__(self, parent=None):
        ...
        self.face_value_edit = CustomDoubleSpinBox()
        ...
        self.interest_rate_edit = CustomDoubleSpinBox()
        ...
        self.flat_yield_edit = CustomDoubleSpinBox()
