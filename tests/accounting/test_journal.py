...
@pytest.fixture
def sample_journal_entry(sample_accounts) -> SimpleEntry:
...
@pytest.fixture
def sample_compound_entry(sample_accounts) -> CompoundEntry:
...
@pytest.fixture
def sample_journal(sample_journal_entry) -> Journal:
...
def test_add_entry(sample_journal, sample_journal_entry) -> None:
...
def test_get_entries_by_date(sample_journal, sample_journal_entry) -> None:
...
def test_get_entries_by_account(sample_journal, sample_accounts, sample_journal_entry) -> None:
...
def test_get_entries_by_description(sample_journal, sample_journal_entry) -> None:
...
def test_get_entries_within_date_range(sample_journal, sample_journal_entry) -> None:
...
def test_remove_entry(sample_journal, sample_journal_entry) -> None:
...
def test_compound_entry_involves_account(sample_compound_entry, sample_accounts) -> None:
...
def test_add_compound_entry(sample_journal, sample_compound_entry) -> None:
